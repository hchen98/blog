...
const BLOG = {
  AUTHOR: 'Hui (Henry) Chen', // 作者
  BIO: 'Love container technologies, ML/DL, Big Data, AWS, and anything related to that!', // 作者简介
  LINK: 'https://hchen98.com', // 网站地址
  KEYWORDS: 'hchen98, blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '0d5d604b9b83497bbba7ad76171d28a0', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  NOTION_ACCESS_TOKEN: process.env.NOTION_ACCESS_TOKEN || '', // Useful if you prefer not to make your database public
  DEBUG: process.env.NEXT_PUBLIC_DEBUG || false, // 是否显示调试按钮

  // https://www.notion.so/hchen98/0d5d604b9b83497bbba7ad76171d28a0?v=fcbfeab8a9254b18942581240a80a151
  ...
  CONTACT_EMAIL: 'hchen60@nyit.edu',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/hchen98',
  CONTACT_TELEGRAM: '',
  // CONTACT_LINKEDIN: 'https://www.linkedin.com/in/hchen98/',
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '9891f850-fc6b-41eb-a5f6-158751151ba6', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-MS2NPY540H', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-3331174264374871', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'hchen98: blog', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
